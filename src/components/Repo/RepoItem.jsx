const RepoItem = ({ repoData }) => {
  ...
  return (
    <div className="p-7 m-4 bg-[#e5e7eb] rounded-xl shadow">
      <div className="flex items-baseline justify-between mb-3">
        ...
        <div>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm rounded-xl"
          >
            Github
          </a>
        </div>
      ...
      <div>
        <div className="mt-2 flex flex-row justify-between w-full font-medium text-sm gap-x-2">
          <div>{stars} Stars</div>
          <div>{forks} Forks</div>
