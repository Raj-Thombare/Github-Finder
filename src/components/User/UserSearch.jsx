...
const UserSearch = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-row bg-[#F0F0F0] md:items-end md:pl-[8px] mb-5 md:mb-0 text-[28px] md:text-[100%] w-[100%] md:w-9/12 p-3 md:p-0	md:px-4 md:py-2 rounded-l-lg rounded-r-lg md:rounded-r-none md:rounded-l-lg focus:outline-none">
        <FiSearch size={30} className="mr-[5px] py-1" />
        <input
          type="search"
          onChange={userInputHandler}
          placeholder="Raj-Thombare"
          className="bg-[#F0F0F0] md:mb-0 text-[22px] md:text-[90%] w-[100%] md:w-9/12 md:p-0 md:px-0 md:py-0 rounded-l-lg rounded-r-lg md:rounded-r-none md:rounded-l-lg focus:outline-none"
        />
      </div>
