...
const User = () => {
  const { dispatch, user, loading } = useContext(UserContext);
  ...
  return (
    <div className="bg-[#f0f0f0] min-h-screen">
      ...
      <div className="min-w-[100%] flex flex-col md:flex md:flex-row ">
        ...
        <div className="min-w-[60%] ml-[0%] md:ml-[40%] p-5">
          {loading ? (
            <p className="card compact side bg-base-100 bg-white p-5 flex flex-col justify-center items-center border rounded-lg shadow-md text-center">
